    ...
    <BrowserRouter future={{ v7_startTransition: true, v7_relativeSplatPath: true }}>
      <Routes>
        ...
        >
          ...
          <Route
            path="/team/:teamId/components/:component"
            element={<TeamComponentDashboardPage />}
          />
          <Route
            path="/team/:teamId/communication"
            element={<TeamCommunicationPage />}
          />
          ...
          <Route
            ...
            element={<MemberDashboardPage isLeaderView />}
          />
        </Route>
