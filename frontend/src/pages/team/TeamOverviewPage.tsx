  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8 animate-slide-up">
      <div className="flex items-center justify-between">
        ...
        <button type="button" onClick={() => void loadTeams()} className="btn-secondary" title="Refresh">
          ...
          {createdCode ? (
            <div className="text-center space-y-4">
              ...
              <div className="flex gap-3">
                <button type="button" onClick={handleCopy} className="btn-secondary flex-1 justify-center">
                  {copied ? (
                    <>
            ...
            <>
              ...
              <form onSubmit={handleCreate} className="space-y-3">
                <div>
                  ...
                  <input
                    className="input"
                    placeholder="e.g. Flutter App Security Team"
                    value={newName}
                ...
                <div className="flex gap-3">
                  <button type="button" onClick={() => setPanel(null)} className="btn-secondary flex-1 justify-center">
                    Cancel
                  </button>
      ...
      {loadingTeams ? (
        ...
        <div className="card text-center py-12 space-y-3">
          ...
          <p className="text-sm text-gray-400">
            Create a new team or join one using an invite code above.
          </p>
        </div>
      ) : (
...
function TeamCard({ team, onClick }: { team: MyTeam; onClick: () => void }) {
  return (
    <button
      type="button"
      onClick={onClick}
      className="card w-full flex items-center justify-between hover:border-brand-500/30 transition-all group text-left"
    >
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          {team.team_code && (
            <p className="text-[11px] text-brand-400 font-mono mt-1">{team.team_code}</p>
          )}
